...
package com.xilu.yinchao.music.utils;

import android.os.Bundle;
import android.support.v4.media.MediaMetadataCompat;
import android.support.v4.media.session.MediaSessionCompat;

import com.xilu.yinchao.music.model.MusicProvider;

import java.util.ArrayList;
import java.util.List;

import static com.xilu.yinchao.music.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static com.xilu.yinchao.music.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
//        return convertToQueue(result, MEDIA_ID_MUSICS_BY_SEARCH, query);
        return convertToQueue(null, MEDIA_ID_MUSICS_BY_SEARCH, query);
    }
