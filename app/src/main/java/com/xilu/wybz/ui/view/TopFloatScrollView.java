 ...
 * ============================================================
 */
public class TopFloatScrollView extends FrameLayout implements com.xilu.wybz.view.MonitorScrollView.OnScrollListener {
    // 新增的放置悬浮的容器
    LinearLayout mAddFloatContainer;
    Context mContext;
    // 滚动的内容View
    com.xilu.wybz.view.MonitorScrollView mContainerSv;
    // ScrollView 的根内容
    ViewGroup mRootView;
    // 悬浮的View
    View mFloatView;
    ...
    void initView() {
        // 添加滚动的ScrollView
        mContainerSv = new com.xilu.wybz.view.MonitorScrollView(mContext);
