...
public class AlertDialogWrapper {
    ...
    public static class Builder {
        ...
        final com.xilu.wybz.view.materialdialogs.MaterialDialog.Builder builder;

        DialogInterface.OnClickListener negativeDialogListener;
        DialogInterface.OnClickListener positiveDialogListener;
        DialogInterface.OnClickListener neutralDialogListener;
        DialogInterface.OnClickListener onClickListener;

        public Builder(@NonNull Context context) {
            builder = new com.xilu.wybz.view.materialdialogs.MaterialDialog.Builder(context);
        }
        ...
        public Builder setAdapter(ListAdapter adapter, final DialogInterface.OnClickListener listener) {
            ...
            builder.listCallbackCustom = new com.xilu.wybz.view.materialdialogs.MaterialDialog.ListCallback() {
                @Override
                public void onSelection(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog, View itemView, int which, CharSequence text) {
        ...
        void addListCallbacks() {
            if (onClickListener != null) {
                builder.itemsCallback(new com.xilu.wybz.view.materialdialogs.MaterialDialog.ListCallback() {
                    @Override
                    public void onSelection(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog, View itemView, int which, CharSequence text) {
        ...
        void addButtonsCallback() {
            if (positiveDialogListener != null || negativeDialogListener != null) {
                builder.callback(new com.xilu.wybz.view.materialdialogs.MaterialDialog.ButtonCallback() {
                    @Override
                    public void onNeutral(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog) {
                    ...
                    @Override
                    public void onPositive(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog) {
                    ...
                    @Override
                    public void onNegative(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog) {
        ...
        void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems, final DialogInterface.OnMultiChoiceClickListener listener) {
            ...
            builder.itemsCallbackMultiChoice(selectedIndicesArr, new com.xilu.wybz.view.materialdialogs.MaterialDialog.ListCallbackMultiChoice() {
                @Override
                public boolean onSelection(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog, Integer[] which, CharSequence[] text) {
        ...
        public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem, final DialogInterface.OnClickListener listener) {
            builder.items(items);
            builder.itemsCallbackSingleChoice(checkedItem, new com.xilu.wybz.view.materialdialogs.MaterialDialog.ListCallbackSingleChoice() {
                @Override
                public boolean onSelection(com.xilu.wybz.view.materialdialogs.MaterialDialog dialog, View itemView, int which, CharSequence text) {
                    listener.onClick(dialog, which);
                    return true;
                }
            });
