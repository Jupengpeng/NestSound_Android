 ...
 */
package com.xilu.wybz.ui.view.kpswitch.handler;
...
import com.xilu.wybz.view.kpswitch.handler.*;
...
public class KPSwitchPanelLayoutHandler implements IPanelConflictLayout {
    ...
    public boolean filterSetVisibility(final int visibility) {
         ...
         *
         * Will be handled on {@link com.xilu.wybz.view.kpswitch.handler.KPSwitchRootLayoutHandler#handleBeforeMeasure(int, int)} ->
         * {@link IPanelConflictLayout#handleShow()} Delay show, until the {@link com.xilu.wybz.view.kpswitch.handler.KPSwitchRootLayoutHandler} discover
