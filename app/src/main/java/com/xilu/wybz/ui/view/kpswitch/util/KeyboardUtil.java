...
public class KeyboardUtil {
    ...
    public static void attach(final Activity activity, IPanelHeightTarget target,
        ...
        final boolean isFullScreen = com.xilu.wybz.view.kpswitch.util.ViewUtil.isFullScreen(activity);
        final boolean isTranslucentStatus = com.xilu.wybz.view.kpswitch.util.ViewUtil.isTranslucentStatus(activity);
        final boolean isFitSystemWindows = com.xilu.wybz.view.kpswitch.util.ViewUtil.isFitsSystemWindows(activity);
