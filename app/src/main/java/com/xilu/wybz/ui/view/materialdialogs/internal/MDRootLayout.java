package com.xilu.wybz.ui.view.materialdialogs.internal;
...
public class MDRootLayout extends ViewGroup {
    ...
    static final int INDEX_NEUTRAL = 0;
    static final int INDEX_NEGATIVE = 1;
    static final int INDEX_POSITIVE = 2;
    boolean mDrawTopDivider = false;
    boolean mDrawBottomDivider = false;
    final MDButton[] mButtons = new MDButton[3];
    boolean mForceStack = false;
    boolean mIsStacked = false;
    boolean mUseFullPadding = true;
    boolean mReducePaddingNoTitleNoButtons;
    boolean mNoTitleNoPadding;

    int mNoTitlePaddingFull;
    int mButtonPaddingFull;
    int mButtonBarHeight;

    GravityEnum mButtonGravity = GravityEnum.START;

    /* Margin from dialog frame to first button */
    int mButtonHorizontalEdgeMargin;

    Paint mDividerPaint;

    ViewTreeObserver.OnScrollChangedListener mTopOnScrollChangedListener;
    ViewTreeObserver.OnScrollChangedListener mBottomOnScrollChangedListener;
    int mDividerWidth;
    ...
    void setUpDividersVisibility(final View view, final boolean setForTop, final boolean setForBottom) {
        if (view == null)
            return;
    ...
    void addScrollListener(final ViewGroup vg, final boolean setForTop, final boolean setForBottom) {
    ...
    void invalidateDividersForScrollingView(ViewGroup view, final boolean setForTop, boolean setForBottom, boolean hasButtons) {
    ...
    void invalidateDividersForWebView(WebView view, final boolean setForTop, boolean setForBottom, boolean hasButtons) {
        if (setForTop) {
            mDrawTopDivider = mTitleBar != null &&
                    mTitleBar.getVisibility() != View.GONE &&
                    //Not scrolled to the top.
    ...
    static boolean canScrollViewScroll(ScrollView sv) {
    ...
    static boolean canWebViewScroll(WebView view) {
        //noinspection deprecation
        return view.getMeasuredHeight() < view.getContentHeight() * view.getScale();
    }

    static boolean canAdapterViewScroll(AdapterView lv) {
