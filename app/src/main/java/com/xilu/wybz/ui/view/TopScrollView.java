...
import com.xilu.wybz.view.MonitorScrollView;
 ...
 * ============================================================
 */
public class TopScrollView extends FrameLayout implements MonitorScrollView.OnScrollListener {
    // 新增的放置悬浮的容器
    ...
    void initAddFloatContainerView() {
        if (mFloatView != null) {
            ...
            mFloatTopContainer.getLayoutParams().height = height;
