...
class DefaultAdapter extends BaseAdapter {
    ...
    final com.xilu.wybz.view.materialdialogs.GravityEnum itemGravity;
    ...
    void setupGravity(ViewGroup view) {
        ...
        if (view.getChildCount() == 2) {
            if (itemGravity == com.xilu.wybz.view.materialdialogs.GravityEnum.END && !isRTL() && view.getChildAt(0) instanceof CompoundButton) {
                ...
                view.addView(second);
                view.addView(first);
            } else if (itemGravity == com.xilu.wybz.view.materialdialogs.GravityEnum.START && isRTL() && view.getChildAt(1) instanceof CompoundButton) {
