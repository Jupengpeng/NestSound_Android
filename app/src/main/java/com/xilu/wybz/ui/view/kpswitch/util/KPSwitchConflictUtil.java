 ...
 */
package com.xilu.wybz.ui.view.kpswitch.util;

import android.app.Activity;
import android.view.MotionEvent;
import android.view.View;

import com.xilu.wybz.view.kpswitch.util.*;
...
public class KPSwitchConflictUtil {
    ...
    public static void showPanel(final View panelLayout) {
        ...
        if (activity.getCurrentFocus() != null) {
            com.xilu.wybz.view.kpswitch.util.KeyboardUtil.hideKeyboard(activity.getCurrentFocus());
        }
    }
    ...
    public static void showKeyboard(final View panelLayout, final View focusView) {
        ...
        com.xilu.wybz.view.kpswitch.util.KeyboardUtil.showKeyboard(focusView);
        if (isHandleByPlaceholder(activity)) {
            panelLayout.setVisibility(View.INVISIBLE);
        }
    }
    ...
    static boolean isHandleByPlaceholder(final Activity activity) {
        return isHandleByPlaceholder(com.xilu.wybz.view.kpswitch.util.ViewUtil.isFullScreen(activity),
                com.xilu.wybz.view.kpswitch.util.ViewUtil.isTranslucentStatus(activity), ViewUtil.isFitsSystemWindows(activity));
    }
