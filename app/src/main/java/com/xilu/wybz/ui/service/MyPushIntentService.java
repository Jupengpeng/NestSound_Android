package com.xilu.wybz.ui.service;
...
import com.xilu.wybz.service.NotificationService;
...
public class MyPushIntentService extends UmengBaseIntentService {
	static final String TAG = MyPushIntentService.class.getName();
	...
	protected void onMessage(Context context, Intent intent) {
		...
		try {
			...
			if(topic != null && topic.equals("appName:startService")) {
				...
				if(SystemUtils.isServiceRunning(context, NotificationService.class.getName()))
					return; 
