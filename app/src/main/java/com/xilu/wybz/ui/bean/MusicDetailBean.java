...
public class MusicDetailBean implements Serializable {
    ...
    String headurl;
    String createday;
    com.xilu.wybz.bean.CommentListBean commentlist;
    ...
    public com.xilu.wybz.bean.CommentListBean getCommentlist() {
        return commentlist;
    }

    public void setCommentlist(com.xilu.wybz.bean.CommentListBean commentlist) {
