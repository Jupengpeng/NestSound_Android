...
public class PhoneInfoUtil {
    ...
    public static String getMachine(Context context) {
        return "android|301|"+ Build.VERSION.RELEASE + "|" + getPhoneModel().toUpperCase() + "|" + getPhoneImei(context) + "|" + com.xilu.wybz.utils.DensityUtil.getScreenW(context) + "|" + com.xilu.wybz.utils.DensityUtil.getScreenH(context);
    }
