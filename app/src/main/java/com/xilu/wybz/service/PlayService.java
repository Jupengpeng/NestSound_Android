...
//                            //下一首 从本地的ids里面取
//                            position++;
//                            if (position == MainService.ids.size()) {
//                                position = 0;
//                            }
//                            if (MainService.ids.size() > 0)
//                                loadData(MainService.ids.get(position));
//                            break;
//                    }
//                }
//            }
...
//        if (MainService.ids.size() > 1) {
//            for (int i = 0; i < MainService.ids.size(); i++) {
//                if (MainService.ids.get(i) == itemid) {
...
//                    position--;
//                    if (position == -1) {
//                        position = MainService.ids.size() - 1;
//                    }
//                    if (position < 0 || position >= MainService.ids.size()) {
//                        PlayMediaInstance.getInstance().stopMediaPlay();
//                        PlayMediaInstance.getInstance().startMediaPlay(currMdb.getPlayurl());
//                    } else {
//                        loadData(MainService.ids.get(position));
